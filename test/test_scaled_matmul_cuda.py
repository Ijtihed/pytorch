...
class TestFP8Matmul(TestCase):
    ...
    def test_scaled_grouped_mm_v2_meta(self, test_case) -> None:
        ...
        if scaling == "rowwise":
            ...
            scale_recipe_a = [ScalingType.RowWise.value]
            scale_recipe_b = [ScalingType.RowWise.value]
            swizzle_a = []
            swizzle_b = []
        elif scaling == "mxfp8":
            scale_a = [
            ...
            scale_recipe_a = [ScalingType.BlockWise1x32.value]
            scale_recipe_b = [ScalingType.BlockWise1x32.value]
            swizzle_a = [SwizzleType.SWIZZLE_32_4_4.value]
            swizzle_b = [SwizzleType.SWIZZLE_32_4_4.value]
        elif scaling == "nvfp4":
            scale_a = [
                torch.empty(
            ...
            scale_recipe_a = [
                ScalingType.BlockWise1x16.value,
